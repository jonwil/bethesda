...
public:
	ImageSpaceModifierForm(FormHeader h,ModFile *f) : Form(h,f), hasImageSpaceModifierData2(false), hasImageSpaceModifierData3(false), hasImageSpaceModifierData4(false)
	{
	}
protected:
