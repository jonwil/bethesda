...
struct RegionDataEntry
{
	...
	RegionDataEntry() : objectCount(0), objects(0), mapName(0), icon(0), grassCount(0), grasses(0), music(0), soundCount(0), sounds(0), weatherCount(0), weatherTypes(0), hasMusicType(false)
	{
	}
