...
#pragma once
#include "form.h"
class FurnitureForm : public Form
{
protected:
	char *editorID;
	char *fullName;
	...
	ulong markers;
public:
	FurnitureForm(FormHeader h,ModFile *f) : Form(h,f), editorID(0), fullName(0), model(0), boundRadius(0), textureHashesCount(0), textureHashes(0), script(0), markers(0)
	{
	}
	virtual ~FurnitureForm()
	{
		if (editorID)
		{
			delete[] editorID;
