...
public:
	LandForm(FormHeader h,ModFile *f) : Form(h,f), flags(0), flagsPresent(false), vertexNormals(0), heightOffset(0), heightValues(0), heightUnk1(0), heightUnk2(0), heightUnk3(0), vertexColors(0), landTextures(0), vertexTextures(0)
	{
	}
	virtual ~LandForm()
	{
		...
		{
			if (landTextures[i].opacities)
			{
				delete[] landTextures[i].opacities;
			}
		}
		if (vertexTextures)
		{
