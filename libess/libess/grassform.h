...
protected:
	...
	GrassData data;
public:
	GrassForm(FormHeader h,ModFile *f) : Form(h,f), editorID(0), model(0), boundRadius(0), textureHashesCount(0), textureHashes(0)
	{
	}
	virtual ~GrassForm()
	{
